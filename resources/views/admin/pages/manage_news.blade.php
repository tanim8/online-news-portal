        ...
        <tbody>
            <?php foreach ($all_news as $v_news) { ?>
                <tr>
                    ...
                    <td><?php echo $short_description = substr($v_news->short_description, 0, 100); ?></td>
                    <td><?php echo $long_description = substr($v_news->long_description, 0, 100); ?></td>
                    ...
                    <a class="btn btn-danger" href="{{URL::to('/delete-news/'.$v_news->id)}}" onclick="return checkDelete()">
